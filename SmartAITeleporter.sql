...
@Tele_Option3_Text          := 'Teleport to _. (Placeholder. Delete if unused.)',
...
@Tele_Option4_Text          := 'Teleport to _. (Placeholder. Delete if unused.)',
...
@Tele_Option5_Text          := 'Teleport to _. (Placeholder. Delete if unused.)',
...
@Tele_Option6_Text          := 'Teleport to _. (Placeholder. Delete if unused.)',
...
@Tele_Option7_Text          := 'Teleport to _. (Placeholder. Delete if unused.)',
...
@Tele_Option8_Text          := 'Teleport to _. (Placeholder. Delete if unused.)',
